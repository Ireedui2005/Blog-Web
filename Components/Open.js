...
export function Open() {
    ...
    return (
        <div className="dark:text-slate-50 md:hidden ">
            <button onClick={openMenu} className="text-2xl"><IoMdMenu /></button>
            <div>
                ...
                <div className={`fixed top-0 bottom-0 transition-all w-64 text-black bg-white shadow-lg ${open ? "right-0" : "-right-full"}`}>
                    <div className="p-4">
                        <div className="flex justify-between ">
                            ...
                            <button onClick={closeMenu} className="text-2xl"><MdClose /></button>
                        </div>
                        <div className="text-[#4B5563]">
                            <div className="mt-[15px]"><button>Home</button></div>
                            <div className="mt-[15px]"><button>Blog</button></div>
                            <div className="mt-[15px]"><button>Contact</button></div>
                        </div>
                    </div>
                </div>
            </div>
